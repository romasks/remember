...
public class HandBookAdapterReligion extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public HandBookAdapterReligion(List<ResponseHandBook> responseHandBooks) {
    ...
    public class HandBookAdapterReligionViewHolder extends BaseViewHolder {
