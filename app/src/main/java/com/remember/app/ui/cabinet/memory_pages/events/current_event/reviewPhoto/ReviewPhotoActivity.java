...
public class ReviewPhotoActivity extends BaseActivity
        implements ReviewView, ReviewViewPager.Count, ReviewAdapter.ItemClickListener, DeleteSlidingPhotoDialog.Callback {

    private final static String TAG = "SlidePhotoActivity";

    @InjectPresenter
    ReviewPhotoPresenter presenter;
    ...
    private ReviewAdapter photoSliderAdapter;
    private ReviewViewPager slidePagerAdapterPhoto;
    ...
    private void initUI(){
        ...
        ArrayList<EventSliderPhotos> responseImagesSliders = (ArrayList<EventSliderPhotos>) extra.getSerializable("objects");
    ...
    public void onDeletePhoto() {
        int photoID = slidePagerAdapterPhoto.getItems().get(currentPosition).getId();
        presenter.deletePhoto(eventID, photoID);
    }
